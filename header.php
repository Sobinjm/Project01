...
window.onclick = function(event) {
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="container">
      ...
      <label>
       ...
       <span class="psw">New <a href="#" onclick="document.getElementById('reg-modal').style.display='block'">User?</a></span>
    </div>
 ...
 <div id="reg-modal" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    <div class="imgcontainer">
      <span onclick="document.getElementById('reg-modal').style.display='none'" class="close" title="Close Modal">&times;</span>
      <!-- <img src="img_avatar2.png" alt="Avatar" class="avatar"> -->
    </div>
            ...
            <div class="container-fluid fixed header">
                ...
                <span class="icon-menu"></span>
                    ...
                    <span class="icon-arrow-down"></span>
                                    ...
                                    <li><a href="#" onclick="document.getElementById('login-modal').style.display='block'" class="btn btn-outline-light top-btn"><span class="ti-plus"></span> Add Listing</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
